...
const StarIcon = ({ filled = true }: { filled?: boolean }) => (
  <svg 
    className={`w-6 h-6 ${filled ? 'text-electric' : 'text-slate-300'}`} 
    fill="currentColor" 
    viewBox="0 0 20 20"
  >
...
const QuoteIcon = () => (
  <svg className="w-12 h-12 text-electric/10 absolute top-4 left-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <RevealOnScroll delay={0.1}>
            <div className="bg-white p-8 rounded-sm relative border border-slate-200 shadow-sm hover:shadow-md transition-all">
                <QuoteIcon />
                ...
                <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-electric text-slate-900 flex items-center justify-center font-bold mr-3">
                    LR
                    </div>
                    <div>
                    <h4 className="text-slate-900 font-semibold">Local Resident</h4>
                    <p className="text-slate-500 text-xs">Brampton, ON</p>
                    </div>
                </div>
                </div>
            </div>
          ...
          <RevealOnScroll delay={0.2}>
            <div className="bg-white p-8 rounded-sm relative border border-slate-200 shadow-sm hover:shadow-md transition-all">
                ...
                <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-slate-100 text-electric border border-electric flex items-center justify-center font-bold mr-3">
                    BO
                    </div>
                    <div>
                    <h4 className="text-slate-900 font-semibold">Business Owner</h4>
                    <p className="text-slate-500 text-xs">Mississauga, ON</p>
                    </div>
                </div>
                </div>
            </div>
